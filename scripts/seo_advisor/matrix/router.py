...
_ROLE_KEYWORDS: dict[str, tuple[str, ...]] = {
    "iris": ("seo", "搜尋", "排名", "關鍵字", "網站健檢", "流量", "收錄"),
    "maya": ("社群", "貼文", "粉專", "instagram", "facebook", "threads", "短影音", "reels"),
    "jack": ("廣告", "投放", "meta ads", "ads", "roas", "cpa", "受眾", "廣告預算"),
    "pixel": ("圖", "圖片", "素材", "banner", "橫幅", "配圖", "產圖", "creative", "視覺", "影片"),
    "cody": ("銷售頁", "landing", "轉換頁", "招生頁", "產品頁", "sales page"),
    "atlas": ("策略", "定位", "市場", "競爭", "商業模式", "成長", "新品", "上市", "轉型"),
    "grace": ("財務", "成本", "毛利", "損益", "現金流", "預算表", "報價", "收入"),
    "tara": ("客服", "faq", "常見問題", "客訴", "售後", "客服話術"),
    "rina": ("流程", "營運", "效率", "sop", "作業流程", "內部流程"),
    "otto": ("自動化", "串接", "workflow", "zapier", "make", "n8n", "api", "排程"),
    "echo": ("新聞稿", "公關", "媒體", "聲明", "公告", "press release"),
    "lex": ("法務", "合約", "條款", "隱私權", "合規", "法律"),
    "doc": ("文件", "知識庫", "手冊", "操作指南", "教材", "documentation"),
    "orion": ("數據", "報表", "儀表板", "dashboard", "kpi", "指標", "成效分析"),
    "nova": ("專案", "時程", "里程碑", "進度", "專案管理", "甘特"),
    "vera": ("品質", "審核", "校對", "檢查", "把關"),
    "luna": ("品牌", "語氣", "標語", "品牌故事", "價值主張", "口吻"),
    "rex": ("業務", "開發客戶", "名單", "陌生開發", "開發信", "bd"),
    "sophia": ("客戶成功", "續約", "回購", "留存", "滿意度"),
    "mira": ("crm", "客戶分群", "會員", "再行銷", "流失"),
